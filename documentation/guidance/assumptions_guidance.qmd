...
| Input ID   | ID in Codebase | Description                     | Format    | Interactions or Dependencies | Calculations    |
|------------|----------------|---------------------------------|-----------|------------------------------|----------------------|
| **Sem_1.1** | `mm_assess_prop_sem` | Percentage of patients starting treatment who will undergo an initial eligibility assessment. | Percentage | Limited to 0 and 100% | This percentage is applied to the number of patients starting treatment. |
